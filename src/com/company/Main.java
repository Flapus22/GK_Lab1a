...
class TransformedShapes extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        ////////////----------------- właściwy kod ---------------------------
        g2.setColor(Color.GREEN);//ustawienie koloru kwadratu na zielony
        g2.translate(300, 300);//Przemieszczenie kwadratu
        square();//Umieszczenie kwadratu
        g2.setColor(g2.getBackground());// zmianna koloru trójkąta na kolor tła(w tym przypadku biały)
        g2.translate(0,25);//przemieszczenie trójkąta
        g2.scale(1, 0.5);//zeskalowanie trójkąta
        triangle();//Stworzenie trójkąta
